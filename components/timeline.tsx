...
const timelineItems = [
  ...
  },
  {
    ...
    color: "#a259ff",
    milestone: true,
    badge: "Multimodal Open",
    desc: "Scout (109B) and Maverick (400B) released. Natively multimodal - text and images. Scout fits on a single H100. Open weights continue.",
    tags: ["Multimodal", "Scout + Maverick"],
  },
  {
    date: "Apr 2025",
    model: "o3 & o4-mini",
    ...
    color: "#ffe566",
    milestone: true,
    badge: "Reasoning Evolution",
    desc: "Next-gen reasoning models. o3 pushes boundaries on complex problems. o4-mini brings reasoning to the masses efficiently.",
    tags: ["Deep reasoning", "Efficient"],
  },
  {
    date: "May 2025",
    ...
    desc: "Google's most advanced reasoning model. Processes text, audio, images, video, and code repos. Deep Think mode for complex problems.",
    tags: ["1M context", "Deep Think"],
  },
  {
    date: "Sep 2025",
    ...
    color: "#00d4ff",
    milestone: false,
    desc: "Improved Flash and Flash-Lite released. Better instruction following, efficiency, and reduced costs. Fast became even faster.",
    tags: ["Low latency", "Cost-efficient"],
  },
  {
    date: "Feb 2026",
    ...
    color: "#ff2d9b",
    milestone: true,
    badge: "Code & Computer Use",
    desc: "Enhanced coding, computer use, and reasoning. Now the default model for Free and Pro users. Agentic capabilities matured.",
    tags: ["Computer use", "Default model"],
  },
  {
    date: "Apr 2026",
    model: "GPT-5.5",
    ...
    desc: "OpenAI's smartest and most intuitive model. GPT-5.5 and GPT-5.5 Pro available via API. The new state of the art.",
    tags: ["Most intuitive", "State of art"],
  },
  {
    date: "Apr 2026",
    ...
    milestone: true,
    badge: "Most Powerful",
    desc: "Anthropic reclaims most powerful LLM. Opus 4.7 brings improved software engineering, vision, and the best writing quality in the market.",
    tags: ["#1 LLM", "Vision upgrade"],
  },
  {
    date: "Apr 2026",
    model: "DeepSeek V4 & R2",
    by: "DeepSeek",
    color: "#00d4ff",
    milestone: true,
    badge: "Open Source Surge",
    desc: "V4-Pro and V4-Flash support 1M context. R2 scores 92.7% on AIME 2025. Open source keeps pace with frontier.",
    tags: ["1M context", "92.7% AIME"],
  },
  {
    date: "Apr 2026",
    model: "Grok 4.20",
    ...
    color: "#ffe566",
    milestone: false,
    desc: "2M token context window - industry leading. Lowest hallucination rate on benchmarks. xAI enters the big leagues.",
    tags: ["2M context", "Low hallucination"],
  },
  {
    date: "Present",
    model: "Where we are",
    ...
    milestone: true,
    badge: "Right Now",
    desc: "GPT-5.5 & Claude Opus 4.7 at the top. Gemini 2.5 Pro competitive. DeepSeek V4 & Grok 4.20 pushing boundaries. 2M context windows. The acceleration continues.",
    tags: ["Multi-model era", "2M contexts"],
  },
];
